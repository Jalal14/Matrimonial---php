...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2018 at 04:18 AM
...
(1, 'adminf', 'adminm', 'adminl', 'admin', '1995-01-11', 2, 1, 'admin@service.com', '016', '015', 'admin', 'propic/admin.jpg', '2017-01-01');
...
(1, 2, 'AIUB', 'CSSE', '2017-12-07'),
(2, 1, 'IUB', 'asdf', '2017-12-01'),
(3, 1, 'Tamirul millat', 'Arts', '2017-12-01');
...
(1, 1, 'name', 'job', 100, 'name', 'occ', 10, '02', 2),
...
INSERT INTO `tbl_favorite` (`uid`, `favorite_user`, `date`) VALUES
(3, 7, '2017-12-16'),
(3, 2, '2017-12-18'),
(1, 4, '2017-12-18'),
(2, 1, '2017-12-19'),
...
INSERT INTO `tbl_job` (`uid`, `designation`, `company`, `joinning_date`) VALUES
(1, 'Intern', 'AIUB', '2017-01-11'),
(2, 'CEO', 'Simplex hub', '2016-12-01'),
(3, 'Intern', 'AIUB', '2017-12-01');
...
(18, 2, 3, '2017-12-19 09:12:35', 'hlw siam', 0),
...
CREATE TABLE `tbl_pr_address` (
  `pr_uid` int(11) NOT NULL,
  `pr_house` varchar(10) NOT NULL,
  `pr_road` varchar(10) NOT NULL,
  `pr_area` varchar(30) NOT NULL,
...
--
-- Dumping data for table `tbl_registration_req`
--

INSERT INTO `tbl_registration_req` (`uid`, `fname`, `mname`, `lname`, `uname`, `dob`, `blood`, `gender`, `email`, `religion`, `number1`, `password`) VALUES
(1, 'shabuz', 'mohammad', 'badsha', 'shabuz', '1991-10-20', 3, 3, 'shabuz@gmail.com', 1, '01711111111', 'shabuz');
...
(1, 'mushfiqur', 'rahman', 'tushar', 'user', '1995-11-01', 1, 1, 'xfx@gmail.com', '01676167636', '', 'user', 'propic/user.jpg', 5.5, 60, 2, 1, 1, 0, 100000, '', '2018-01-06 04:01:20'),
(2, 'userf', 'userm', 'userl', 'u', '1990-01-02', 1, 1, 'user@mail.com', '0155', '0122', 'u', 'propic/u.jpg', 4, 55, 2, 1, 1, 2, 300000000, 'nothing', '2018-01-03 03:01:00'),
(3, 'Siam', 'Hasan', 'Evan', 'a', '1995-12-05', 1, 2, 'siam@gmail.com', '011', '', 'a', 'propic/a.jpg', 6, 70, 2, 1, 1, 0, 1300, '', '2017-12-19 00:00:00'),
(4, 'Siam', 'Hasan', 'Evan', 'vv', '1993-12-18', 1, 1, 'siamhasan05@gmail.com', '01710987607', NULL, '0000', 'defaultpic/user.png', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, '2017-12-23 09:12:28'),
(5, 'Ashik', 'Mahmud', 'Ashik', 'ashik', '1994-12-30', 1, 1, 'abc@gmail.com', '12345678', NULL, '1234', 'propic/ashik.jpg', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, '2017-12-19 09:12:57'),
(7, 'masud', '', 'rana', 'masud', '1990-01-01', 3, 1, 'masud@gmail.com', '0111111', NULL, 'masud', 'propic/masud.png', NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL, '2018-01-03 11:01:20'),
(9, 'jalal', 'middle', 'uddin', 'aser', '2017-12-07', 3, 3, 'jalaluddin_csse14@yahoo.com', 'asdf', NULL, '1111', 'defaultpic/user.png', NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL, '2017-12-20 09:12:04'),
...
--
CREATE TABLE `view_admin_details` (
`aid` int(11)
,`fname` varchar(30)
,`mname` varchar(30)
,`lname` varchar(30)
...
--
CREATE TABLE `view_family_details` (
`uid` int(11)
,`type` int(11)
...
--
CREATE TABLE `view_per_address_details` (
`per_uid` int(11)
...
--
CREATE TABLE `view_police_station_details` (
`police_station_id` int(11)
,`police_station_name` varchar(50)
,`district_id` int(11)
,`district_name` varchar(50)
...
--
CREATE TABLE `view_pr_address_details` (
`pr_uid` int(11)
,`pr_house` varchar(10)
,`pr_road` varchar(10)
,`pr_area` varchar(30)
...
--
CREATE TABLE `view_registration_req` (
`uid` int(11)
,`fname` varchar(30)
,`mname` varchar(30)
,`lname` varchar(30)
...
--
CREATE TABLE `view_user_details` (
`uid` int(11)
,`fname` varchar(30)
,`mname` varchar(30)
,`lname` varchar(30)
...
--
CREATE TABLE `view_user_education` (
`uid` int(11)
,`degree` int(11)
,`institution` varchar(50)
,`field` varchar(50)
...
--
CREATE TABLE `view_user_interest` (
`uid` int(11)
,`interest` int(11)
...
--
-- Indexes for table `tbl_complexion`
--
ALTER TABLE `tbl_complexion`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `tbl_education`
  ADD UNIQUE KEY `user_id` (`uid`),
  ADD KEY `user_id_2` (`uid`),
...
--
-- Indexes for table `tbl_family_type`
--
...
ALTER TABLE `tbl_friend`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id1` (`sender`),
  ADD KEY `user_id2` (`send_to`);

--
-- Indexes for table `tbl_friend_req`
--
...
ALTER TABLE `tbl_per_address`
  ADD UNIQUE KEY `per_user_id` (`per_uid`),
  ADD KEY `per_user_id_2` (`per_uid`),
  ADD KEY `per_police_station` (`per_police_station`);
...
--
-- Indexes for table `tbl_pr_address`
--
ALTER TABLE `tbl_pr_address`
  ADD UNIQUE KEY `user_id` (`pr_uid`),
  ADD KEY `user_id_2` (`pr_uid`),
  ADD KEY `police_station` (`pr_police_station`);

--
-- Indexes for table `tbl_registration_req`
--
...
ALTER TABLE `tbl_users`
  ...
  ADD KEY `complexion` (`complexion`),
  ADD KEY `gender` (`gender`);

--
-- Indexes for table `tbl_user_hobby`
--
...
--
-- Indexes for table `tbl_user_sports`
--
...
--
-- AUTO_INCREMENT for table `tbl_complexion`
--
ALTER TABLE `tbl_complexion`
...
--
-- AUTO_INCREMENT for table `tbl_family_type`
--
ALTER TABLE `tbl_family_type`
...
--
-- AUTO_INCREMENT for table `tbl_registration_req`
--
ALTER TABLE `tbl_registration_req`
...
--
ALTER TABLE `tbl_users`
  ADD CONSTRAINT `tbl_users_ibfk_1` FOREIGN KEY (`blood`) REFERENCES `tbl_blood` (`id`),
